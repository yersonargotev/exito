...
describe('ProductCard', () => {
  const mockUseProductCart = require('@/hooks/use-cart')
    .useProductCart as jest.Mock;
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle long product titles', () => {
      const productWithLongTitle = {
        ...mockProduct,
        title:
          'This is a very long product title that should be truncated or handled gracefully by the component',
      };
