...
export const LazyCheckoutSteps = dynamic(
    () => import('./checkout/checkout-steps').then(mod => ({ default: mod.CheckoutSteps })),
    {
...
export const LazyOrderSummary = dynamic(
    () => import('./checkout/order-summary').then(mod => ({ default: mod.OrderSummary })),
    {
        loading: () => (
...
export const LazyPersonalInfoForm = dynamic(
    () => import('./checkout/personal-info-form').then(mod => ({ default: mod.PersonalInfoForm })),
    {
        loading: () => <LoadingSpinner />,
    }
);
...
export const LazyPaymentInfoForm = dynamic(
    () => import('./checkout/payment-info-form').then(mod => ({ default: mod.PaymentInfoForm })),
    {
        loading: () => <LoadingSpinner />,
    }
);
